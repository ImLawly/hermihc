...
const FEATURES: FeatureCheck[] = [
  ...
  { id: "3", title: "Chat interno con vigilancia del superusuario", status: "done",
    description: "Chat 1-a-1 y grupos con realtime. El superusuario ve todas las conversaciones del sistema. Check de entrega (sin check de lectura)." },
  { id: "4", title: "Bloqueo y publicación de historias por rangos", status: "done",
    description: "R1 crea como borrador. R2/R3 abre 'Revisar' → bloquea al autor con record_locks (heartbeat 4min) → Confirma y publica. Publicado = inmutable (RLS lo impide, excepto superusuario)." },
  { id: "5", title: "Links temporales alfanuméricos (15min - 48h)", status: "done",
    description: "Botón 'Link temporal' en la historia del paciente. Ruta pública /v/$token con vista de solo lectura. Panel de superusuario para ver, contar accesos y revocar." },
